...
export { CompoundHeader } from "../../components/ui/CompoundHeader";
export { CompoundTypeSchedule } from "../../components/ui/CompoundTypeSchedule";

export type { CompoundDetails } from "./types";
